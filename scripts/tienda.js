...
function actualizarBotonCarrito() {
    ...
    if (btnCart) {
        btnCart.textContent = `🛒 Cart (${totalEnCarrito})`;
    }
}
...
function crearTarjeta(cerveza) {
    ...
    col.className = "column is-12-mobile is-6-tablet is-6-desktop";
    ...
    col.innerHTML = `
        <div class="card">
            ...
            <div class="card-content">
                <p class="title card-name mb-1 has-text-dark">${cerveza.nombre}</p>
            ...
            <footer class="card-footer p-3 is-flex is-justify-content-space-between is-align-items-center">
                ...
                <div class="buttons are-small mb-0">
                    ...
                    <span class="button is-static cantidad-texto has-text-weight-bold" style="min-width: 36px;">0</span>
